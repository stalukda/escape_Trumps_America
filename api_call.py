...
#             json_obj = urllib2.urlopen(url) 
#             data = json.load(json_obj)
#             print "average price in {}:".format(country), average_price(data, "Apartment (1 bedroom) in City Centre, Rent Per Month")
...
# average_price("Apartment (1 bedroom) in City Centre, Rent Per Month")
# average_price("Meal, Inexpensive Restaurant, Restaurants")
# average_price("Fresh White Bread (500g)")
